           ...
           <div className="big-imgg">
              ...
              <div className="boxx">
                <div className="rows">
                  ...
                  {thisProduct.prixPromotion==="0"?   <span>MAD {thisProduct.prixProd}</span> : <span>MAD {thisProduct.prixPromotion}</span>}
              ...
              <div className="thumb" >
               ...
               <button className="cart" onClick={() => addToCart(thisProduct)}>Ajouter au panier</button>
